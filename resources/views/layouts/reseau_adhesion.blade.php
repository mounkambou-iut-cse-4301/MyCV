@extends('layouts/master',['title'=>'Réseaux et adhésions'])
                ...
                <div class="col-lg-8">
                    <div class="d-flex flex-column h-100 bg-light rounded-3 shadow-lg p-4">
                        <div class="py-2 p-md-3">
                            ...
                            <form action="{{route('reseau_adhesion')}}" method="post">
                                <div class="row">
                                    <h3
                                ...
                                <table class="table table-hover mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-3 align-middle"><a class="nav-link-style text-danger" href="/delete_reseau_adhesion/{{$inf->id}}  "
