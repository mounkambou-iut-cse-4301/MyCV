                ...
                <div class="col-lg-8">
                    <div class="d-flex flex-column h-100 bg-light rounded-3 shadow-lg p-4">
                        <div class="py-2 p-md-3">
                            ...
                            <form action="{{route('prix_distinction')}}" method="post">
                                <div class="row">
                                    <h3
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="account-ln">Établissement qui l'a décerné(e)</label>
                                            <input class="form-control" name="etablissement" type="text" id="account-ln" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="date">Date de la remise</label>
                                            <input class="form-control" name="date" type="date" id="date" value="21/202/1999">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label" for="cont-message">Description</label>
                                            <textarea class="form-control" name="descrition" placeholder="Saisir ici la description..." id="cont-message" rows="5"
                                                ></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="py-3 align-middle">
                                                ...
                                                <span >{{$inf->etablissement}}</span><br>
                                                <span>{{$inf->description}}</span>
                                                <a href="{{$inf->lien}}" target="_blank">{{$inf->lien}}</a>
                                            </td>
                                            <td class="py-3 align-middle">{{$inf->date}}</td>
                                            <td class="py-3 align-middle"><a class="nav-link-style text-danger" href="/delete_prix_distinction/{{$inf->id}}"
