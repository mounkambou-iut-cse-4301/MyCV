...
<head>
    ...
    <!-- FontAwesome JS-->
	<script defer src="assets2/fontawesome/js/all.min.js"></script>
       
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="assets2/css/pillar-1.css">
		    ...
		    <header class="resume-header pt-4 pt-md-0">
			    <div class="row">
				    <div class="col-block col-md-auto resume-picture-holder text-center text-md-start">
				        <img class="picture" src="assets2/images/profile.jpg" alt="">
				    </div><!--//col-->
				    <div class="col">
