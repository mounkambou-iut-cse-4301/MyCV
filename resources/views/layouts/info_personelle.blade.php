                        ...
                        <div class="py-2 p-md-3">
                            ...
                            <form action="">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="date">Date de naissance</label>
                                            <input class="form-control" type="date" id="date" value="21/202/1999">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="account-country">Sexe</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="Nationalité">Nationalité</label>
                                            <input class="form-control" type="text" id="Nationalité"
                                                value="Camenounaise">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="email">Email</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="tel">Numéro de téléphone</label>
                                            <input class="form-control" type="number" id="tel" value="692473511">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="twitter">Twitter</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
                                            <label class="form-label px-0" for="ville">Ville</label>
                                            <input class="form-control" type="text" id="ville" value="Yaoundé">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3 pb-1">
