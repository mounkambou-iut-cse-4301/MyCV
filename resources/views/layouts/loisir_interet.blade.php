@extends('layouts/master',['title'=>'Loisirs et centres d’intérêt'])
                ...
                <div class="col-lg-8">
                    <div class="d-flex flex-column h-100 bg-light rounded-3 shadow-lg p-4">
                        <div class="py-2 p-md-3">
                            ...
                            <form action="{{route('loisir_interet')}}" method="post">
                                <div class="row">
                                    <h3
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3 pb-1">
                                            ...
                                            <textarea class="form-control" name="description" placeholder="Liste..." id="cont-message" rows="5"
                                               required ></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="py-3 align-middle">
                                                <p class="fw-bold">{{$inf->description}}</p>
                                                <a href="{{$inf->lien}}" target="_blank">{{$inf->lien}}</a>
                                            </td>
                                            <td class="py-3 align-middle"><a class="nav-link-style text-danger" href="/delete_loisir/{{$inf->id}}  "
