@extends('layouts/master',['title'=>'Compétences en matière de gestion et de direction'])
                ...
                <div class="col-lg-8">
                    <div class="d-flex flex-column h-100 bg-light rounded-3 shadow-lg p-4">
                        <div class="py-2 p-md-3">
                            ...
                            <form action="{{route('competence_matiere_gestion')}}" method="post">
                                <div class="row">
                                    <h3
                                ...
                                <table class="table table-hover mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-3 align-middle"><a class="nav-link-style text-danger" href="/delete_comp_gestion/{{$inf->id}}  "
